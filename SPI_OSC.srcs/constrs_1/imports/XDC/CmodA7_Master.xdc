...
set_property -dict {PACKAGE_PIN U1 IOSTANDARD LVCMOS33} [get_ports {SS[0]}]
set_property -dict {PACKAGE_PIN W2 IOSTANDARD LVCMOS33} [get_ports MOSI]
set_property -dict {PACKAGE_PIN V2 IOSTANDARD LVCMOS33} [get_ports SCK]
